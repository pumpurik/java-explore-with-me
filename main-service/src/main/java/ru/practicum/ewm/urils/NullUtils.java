...
public class NullUtils {
    public static final BiFunction<String, String, Boolean> equalsIgnoreNullFalse = (f, s) -> {
        if (f == null || s == null) return false;
        else return f.equals(s);
    };
    public static final BiFunction<String, String, Boolean> equalsIgnoreNullTrue = (f, s) -> {
